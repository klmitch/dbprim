...
unsigned long \hyperlink{group__dbprim__hash_ga17}{ht\_\-free} (\hyperlink{struct__hash__table__s}{hash\_\-table\_\-t} $\ast$table)
\begin{CompactList}\small\item\em Free memory used by an empty hash table. \item\end{CompactList}\item 
unsigned long \hyperlink{group__dbprim__hash_ga18}{he\_\-init} (\hyperlink{struct__hash__entry__s}{hash\_\-entry\_\-t} $\ast$entry, void $\ast$value)
...
unsigned long \hyperlink{group__dbprim__smat_ga23}{sh\_\-iter} (\hyperlink{struct__smat__head__s}{smat\_\-head\_\-t} $\ast$head, \hyperlink{struct__smat__entry__s}{smat\_\-entry\_\-t} $\ast$start, \hyperlink{group__dbprim__smat_ga4}{smat\_\-iter\_\-t} iter\_\-func, void $\ast$extra, unsigned long flags)
\begin{CompactList}\small\item\em Iterate over each entry in a row or column of a sparse matrix. \item\end{CompactList}\item 
unsigned long \hyperlink{dbprim_8h_a178}{sh\_\-flush} (\hyperlink{struct__smat__head__s}{smat\_\-head\_\-t} $\ast$head, \hyperlink{group__dbprim__smat_ga4}{smat\_\-iter\_\-t} flush\_\-func, void $\ast$extra)
...
unsigned long \hyperlink{group__dbprim__rbtree_ga11}{rt\_\-iter} (\hyperlink{struct__rb__tree__s}{rb\_\-tree\_\-t} $\ast$tree, \hyperlink{struct__rb__node__s}{rb\_\-node\_\-t} $\ast$start, \hyperlink{group__dbprim__rbtree_ga2}{rb\_\-iter\_\-t} iter\_\-func, void $\ast$extra, unsigned long flags)
...
unsigned long \hyperlink{group__dbprim__rbtree_ga13}{rn\_\-init} (\hyperlink{struct__rb__node__s}{rb\_\-node\_\-t} $\ast$node, void $\ast$value)
...
Definition at line 1110 of file dbprim.h.
...
Definition at line 2566 of file dbprim.h.

Referenced by rt\_\-add(), rt\_\-flush(), rt\_\-iter(), rt\_\-move(), and rt\_\-remove().

\subsection{Function Documentation}
\hypertarget{dbprim_8h_a178}{
\index{dbprim.h@{dbprim.h}!sh_flush@{sh\_\-flush}}
\index{sh_flush@{sh\_\-flush}!dbprim.h@{dbprim.h}}
...
\begin{center}
\leavevmode
\includegraphics[width=315pt]{dbprim_8h_a178_cgraph}
\end{center}
\end{figure}
