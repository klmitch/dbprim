...
This file contains the implementation of the \hyperlink{group__dbprim__rbtree_ga8}{rt\_\-remove()} function, used to remove a node from a red-black tree.\end{Desc}
