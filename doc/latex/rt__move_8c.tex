...
This file contains the implementation of the \hyperlink{group__dbprim__rbtree_ga7}{rt\_\-move()} function, used to move a node within a red-black tree to correspond to a new key.\end{Desc}
