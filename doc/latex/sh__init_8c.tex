...
This file contains the implementation of the \hyperlink{group__dbprim__smat_ga20}{sh\_\-init()} function, used to dynamically initialize a sparse matrix head structure.\end{Desc}
