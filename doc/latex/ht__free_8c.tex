...
This file contains the implementation of the \hyperlink{group__dbprim__hash_ga17}{ht\_\-free()} function, used to release memory still in use by an empty hash table.\end{Desc}
