...
This file contains the implementation of the \hyperlink{group__dbprim__smat_ga16}{st\_\-iter()} function, used to iterate over all entries in a sparse matrix table.\end{Desc}
