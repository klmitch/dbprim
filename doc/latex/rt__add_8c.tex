...
This file contains the implementation of the \hyperlink{group__dbprim__rbtree_ga6}{rt\_\-add()} function, used to add a red-black tree node to a given tree.\end{Desc}
