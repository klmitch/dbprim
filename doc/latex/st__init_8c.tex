...
This file contains the implementation of the \hyperlink{group__dbprim__smat_ga12}{st\_\-init()} function, used to dynamically initialize a sparse matrix table.\end{Desc}
