...
This file contains the implementation of the \hyperlink{group__dbprim__smat_ga17}{st\_\-flush()} function, used to release all entries in a sparse matrix table.\end{Desc}
