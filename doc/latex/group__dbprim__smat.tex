...
typedef unsigned long($\ast$ \hyperlink{group__dbprim__smat_a3}{smat\_\-resize\_\-t} )(\hyperlink{dbprim_8h_a0}{smat\_\-table\_\-t} $\ast$, unsigned long)
\begin{CompactList}\small\item\em Sparse matrix table resize callback. \item\end{CompactList}\item 
typedef unsigned long($\ast$ \hyperlink{group__dbprim__smat_a4}{smat\_\-iter\_\-t} )(\hyperlink{dbprim_8h_a0}{smat\_\-table\_\-t} $\ast$, \hyperlink{dbprim_8h_a2}{smat\_\-entry\_\-t} $\ast$, void $\ast$)
\begin{CompactList}\small\item\em Sparse matrix iteration callback. \item\end{CompactList}\item 
typedef unsigned long($\ast$ \hyperlink{group__dbprim__smat_a5}{smat\_\-comp\_\-t} )(\hyperlink{dbprim_8h_a0}{db\_\-key\_\-t} $\ast$, \hyperlink{dbprim_8h_a2}{smat\_\-entry\_\-t} $\ast$)
