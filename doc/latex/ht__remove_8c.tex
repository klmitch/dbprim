...
This file contains the implementation of the \hyperlink{group__dbprim__hash_ga12}{ht\_\-remove()} function, used to remove an entry from a hash table.\end{Desc}
