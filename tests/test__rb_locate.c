...
test_find_in_tree(void **state)
{
  ...
  assert_ptr_equal(result, &rank2_1);
  assert_ptr_equal(tree.rt_root, &root);
  assert_int_equal(tree.rt_count, 3);
...
main(void)
{
  const struct CMUnitTest tests[] = {
    ...
    cmocka_unit_test(test_find_in_tree),
