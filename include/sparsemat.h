 ...
 * be regarded as a "column."  Which one is used for which type of
 * data is irrelevant, as long as consistency is maintained.  For the
 * above example, a #smat_head_t for a manager may be #SMAT_LOC_FIRST,
