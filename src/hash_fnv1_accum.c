...
/** \internal
 * \file
 * \brief Implementation of hash_fnv1_accum().
 *
 * This file contains the implementation of the hash_fnv1_accum()
...
db_err_t
hash_fnv1_accum(hash_fnv_state_t *state, void *data, size_t len)
{
  unsigned char *c;
